...
- isimlendirilmis ctor

- yalnizca dinamik omurlu nesneler
...
- aslinda kendisi bir sinif nesnesi olan
- bir pointer gibi kullanilan
- pointer interface
...
```
- eger new ifadesi ile oluturugumuz sinif nesnesini
- ilgili delete ifadesi ile sonlandirmaz isek

- 1) destructor cagrilmayacak.
- 2) operator delete cagrilmayacak
...
- !!!! EGER DELETE yapmazsam destructor cagrilmiyor.
